...
class SERCOM
{
	public:
		...
		uint16_t transferDataSPI(uint8_t data); // *** NEW ***
		void transferDataSPI(void *buf, uint32_t count); // *** NEW ***
		void transferDataSPI(void *buf, uint32_t count, uint8_t transmit); // *** NEW ***
		void transferDataSPI(uint32_t count, uint8_t transmit); // *** NEW ***
