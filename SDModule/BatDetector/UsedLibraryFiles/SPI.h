...
class SPIClass {
  ...
  inline void transfer(void *buf, size_t count, uint8_t transfer); // *** NEW ***
  inline void transfer(size_t count, uint8_t transfer); // *** NEW ***
...
void SPIClass::write(uint8_t data)
{
 ...
 _p_sercom->writeDataSPI(data);
 //_p_sercom->transferDataSPI(data);
...
void SPIClass::transfer(void *buf, size_t count, uint8_t transfer)
{
  _p_sercom->transferDataSPI(buf, count, transfer);  
}

void SPIClass::transfer(size_t count, uint8_t transfer)
{
  _p_sercom->transferDataSPI(count, transfer);  
}
